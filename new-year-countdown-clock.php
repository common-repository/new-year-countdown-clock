...
Author: enclick
Version: 1.0
Author URI: https://mycountdown.org
Plugin URI: https://mycountdown.org/wordpress-countdown-clock-plugin/
*/
...
function new_year_countdown_clock_init() 
{
	...
	if ( $_POST['new-year-countdown-clock-submit'] ) {
	     ...
	     $options_flag=1;
      	...
      	echo '<ul><li style="text-align:center;list-style: none;"><label for="new-year-countdown-clock-title">New Year Countdown Clock<br> by <a href="https://mycountdown.org">mycountdown.org</a></label></li>';
...
print "<br> TZ: " . $timezone;
	...
	$target_url= "https://mycountdown.org/$group/";
	...
	$widget_call_string = 'https://mycountdown.org/wp_countdown-clock.php?group='.$group_code;
	...
	echo '<img src="https://mycountdown.org/images/countries/'.$group_code.'.png" border=0 style="border:0;margin:0;padding:0">&nbsp;&nbsp;'.$title.'</a></div>' . $noscript_end;
